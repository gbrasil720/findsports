  ...
  return (
    <div className="bg-white rounded-2xl ring-1 ring-black/5 p-12 flex flex-col items-center gap-4 text-center">
      <div className="size-16 rounded-2xl bg-zinc-100 flex items-center justify-center">
        <HugeiconsIcon icon={CalendarsIcon} size={28} color="currentColor" strokeWidth={1.5} className="text-zinc-400" />
      </div>
      <div>
      ...
      >
        <HugeiconsIcon icon={PlusSignIcon} size={16} color="currentColor" strokeWidth={1.5} /> Adicionar primeiro jogo
      </button>
    </div>
  )
}
