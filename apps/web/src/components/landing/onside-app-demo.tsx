  ...
  return (
    <figure className="onside-product-stage">
        ...
        <div className="onside-phone-content">
          ...
          <div className="onside-demo-views">
            ...
            >
              ...
              <span className="onside-map-pin onside-pin-a" aria-hidden="true">
                1
              </span>
              <span className="onside-map-pin onside-pin-b" aria-hidden="true">
                2
              </span>
              <span className="onside-map-pin onside-pin-c" aria-hidden="true">
                3
              </span>
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span className="onside-check">✓</span>
        <div>
          <b>Transmissão confirmada</b>
          <small>Atualizada pelo bar</small>
        </div>
      </div>
      <div className="onside-floating-note onside-note-city" aria-hidden="true">
